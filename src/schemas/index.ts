...
export const DEVOPS_METRICS_SCHEMA: SheetSchema = {
  ...
  columns: [
    ...
    { id: "mttrHours", header: "平均復旧時間 (時間)", type: "number", numberFormat: "#,##0.0", defaultValue: "N/A" },
  ],
};
...
export const DEVOPS_SUMMARY_SCHEMA: SheetSchema = {
  ...
  columns: [
    { id: "repository", header: "リポジトリ", type: "string" },
    { id: "avgDeploymentFrequency", header: "平均デプロイ頻度", type: "number", numberFormat: "#,##0.0" },
    { id: "avgLeadTimeHours", header: "平均リードタイム (時間)", type: "number", numberFormat: "#,##0.0" },
    { id: "avgChangeFailureRate", header: "平均変更障害率 (%)", type: "number", numberFormat: "#,##0.0" },
...
export const CYCLE_TIME_SCHEMA: SheetSchema = {
  ...
  columns: [
    ...
    { id: "avgCycleTimeHours", header: "平均サイクルタイム (時間)", type: "number", numberFormat: "#,##0.0" },
    { id: "avgCycleTimeDays", header: "平均サイクルタイム (日)", type: "number", numberFormat: "#,##0.0" },
...
export const CYCLE_TIME_DETAIL_SCHEMA: SheetSchema = {
  ...
  columns: [
    ...
    { id: "cycleTimeHours", header: "サイクルタイム (時間)", type: "number", numberFormat: "#,##0.0" },
...
export const CODING_TIME_SCHEMA: SheetSchema = {
  ...
  columns: [
    ...
    { id: "avgCodingTimeHours", header: "平均コーディング時間 (時間)", type: "number", numberFormat: "#,##0.0" },
    { id: "avgCodingTimeDays", header: "平均コーディング時間 (日)", type: "number", numberFormat: "#,##0.0" },
    { id: "medianHours", header: "中央値 (時間)", type: "number", numberFormat: "#,##0.0" },
    { id: "minHours", header: "最小 (時間)", type: "number", numberFormat: "#,##0.0" },
    { id: "maxHours", header: "最大 (時間)", type: "number", numberFormat: "#,##0.0" },
    { id: "recordedAt", header: "記録日時", type: "date" },
...
export const CODING_TIME_DETAIL_SCHEMA: SheetSchema = {
  ...
  columns: [
    ...
    { id: "codingTimeHours", header: "コーディング時間 (時間)", type: "number", numberFormat: "#,##0.0" },
    { id: "codingTimeDays", header: "コーディング時間 (日)", type: "number", numberFormat: "#,##0.0" },
  ],
};
...
export const REWORK_RATE_SCHEMA: SheetSchema = {
  ...
  columns: [
    ...
    { id: "additionalCommitsTotal", header: "追加コミット数 (合計)", type: "number", numberFormat: "#,##0" },
    { id: "additionalCommitsAvg", header: "追加コミット数 (平均)", type: "number", numberFormat: "#,##0.0" },
    { id: "additionalCommitsMedian", header: "追加コミット数 (中央値)", type: "number", numberFormat: "#,##0.0" },
    { id: "additionalCommitsMax", header: "追加コミット数 (最大)", type: "number", numberFormat: "#,##0" },
    { id: "forcePushTotal", header: "Force Push回数 (合計)", type: "number", numberFormat: "#,##0" },
    { id: "forcePushAvg", header: "Force Push回数 (平均)", type: "number", numberFormat: "#,##0.0" },
    { id: "prsWithForcePush", header: "Force Pushがあった PR数", type: "number", numberFormat: "#,##0" },
...
export const REVIEW_EFFICIENCY_SCHEMA: SheetSchema = {
  ...
  columns: [
    { id: "period", header: "期間", type: "string" },
    { id: "prCount", header: "PR数", type: "number", numberFormat: "#,##0" },
    { id: "timeToFirstReviewAvg", header: "レビュー待ち時間 (平均)", type: "number", numberFormat: "#,##0.0" },
    { id: "timeToFirstReviewMedian", header: "レビュー待ち時間 (中央値)", type: "number", numberFormat: "#,##0.0" },
    { id: "timeToFirstReviewMin", header: "レビュー待ち時間 (最小)", type: "number", numberFormat: "#,##0.0" },
    { id: "timeToFirstReviewMax", header: "レビュー待ち時間 (最大)", type: "number", numberFormat: "#,##0.0" },
    { id: "reviewDurationAvg", header: "レビュー時間 (平均)", type: "number", numberFormat: "#,##0.0" },
    { id: "reviewDurationMedian", header: "レビュー時間 (中央値)", type: "number", numberFormat: "#,##0.0" },
    { id: "reviewDurationMin", header: "レビュー時間 (最小)", type: "number", numberFormat: "#,##0.0" },
    { id: "reviewDurationMax", header: "レビュー時間 (最大)", type: "number", numberFormat: "#,##0.0" },
    { id: "timeToMergeAvg", header: "マージ待ち時間 (平均)", type: "number", numberFormat: "#,##0.0" },
    { id: "timeToMergeMedian", header: "マージ待ち時間 (中央値)", type: "number", numberFormat: "#,##0.0" },
    { id: "timeToMergeMin", header: "マージ待ち時間 (最小)", type: "number", numberFormat: "#,##0.0" },
    { id: "timeToMergeMax", header: "マージ待ち時間 (最大)", type: "number", numberFormat: "#,##0.0" },
...
export const REVIEW_EFFICIENCY_DETAIL_SCHEMA: SheetSchema = {
  ...
  columns: [
    ...
    { id: "mergedAt", header: "マージ日時", type: "date" },
    { id: "timeToFirstReviewHours", header: "レビュー待ち時間 (時間)", type: "number", numberFormat: "#,##0.0" },
    { id: "reviewDurationHours", header: "レビュー時間 (時間)", type: "number", numberFormat: "#,##0.0" },
    { id: "timeToMergeHours", header: "マージ待ち時間 (時間)", type: "number", numberFormat: "#,##0.0" },
...
export const PR_SIZE_SCHEMA: SheetSchema = {
  ...
  columns: [
    ...
    { id: "linesOfCodeMedian", header: "変更行数 (中央値)", type: "number", numberFormat: "#,##0.0" },
    { id: "linesOfCodeMin", header: "変更行数 (最小)", type: "number", numberFormat: "#,##0" },
    { id: "linesOfCodeMax", header: "変更行数 (最大)", type: "number", numberFormat: "#,##0" },
    { id: "filesChangedTotal", header: "変更ファイル数 (合計)", type: "number", numberFormat: "#,##0" },
    { id: "filesChangedAvg", header: "変更ファイル数 (平均)", type: "number", numberFormat: "#,##0.0" },
    { id: "filesChangedMedian", header: "変更ファイル数 (中央値)", type: "number", numberFormat: "#,##0.0" },
    { id: "filesChangedMin", header: "変更ファイル数 (最小)", type: "number", numberFormat: "#,##0" },
    { id: "filesChangedMax", header: "変更ファイル数 (最大)", type: "number", numberFormat: "#,##0" },
    { id: "recordedAt", header: "記録日時", type: "date" },
  ],
};
